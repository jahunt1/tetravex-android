...
public abstract class FourBaseRecord extends AndroidBaseRecord {

    public static final String DATABASE = "main";
    public static final String TABLE = "FOUR";
    public static final String FULL_TABLE = "main.FOUR";
    public static final String PRIMARY_KEY_COLUMN = "_id";
    public static final String C_ID = "_id";
    public static final String FULL_C_ID = "FOUR._id";
    private long id = 0;
    public static final String C_TIME = "TIME";
    public static final String FULL_C_TIME = "FOUR.TIME";
    private String time = "";
    public static final String C_SCORE_DATE = "SCORE_DATE";
    public static final String FULL_C_SCORE_DATE = "FOUR.SCORE_DATE";
    private org.joda.time.DateTime scoreDate = null;
    public static final String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS FOUR (" + 
        ...
        "" + 
        "";
    public static final String DROP_TABLE = "DROP TABLE IF EXISTS FOUR;";
     static final String[] ALL_KEYS = new String[] {
        C_ID,
        C_TIME,
        C_SCORE_DATE};

    public FourBaseRecord() {
    }
