...
public abstract class FiveBaseRecord extends AndroidBaseRecord {

    public static final String DATABASE = "main";
    public static final String TABLE = "FIVE";
    public static final String FULL_TABLE = "main.FIVE";
    public static final String PRIMARY_KEY_COLUMN = "_id";
    public static final String C_ID = "_id";
    public static final String FULL_C_ID = "FIVE._id";
    private long id = 0;
    public static final String C_TIME = "TIME";
    public static final String FULL_C_TIME = "FIVE.TIME";
    private String time = "";
    public static final String C_SCORE_DATE = "SCORE_DATE";
    public static final String FULL_C_SCORE_DATE = "FIVE.SCORE_DATE";
    private org.joda.time.DateTime scoreDate = null;
    public static final String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS FIVE (" + 
        ...
        "" + 
        "";
    public static final String DROP_TABLE = "DROP TABLE IF EXISTS FIVE;";
     static final String[] ALL_KEYS = new String[] {
        C_ID,
        C_TIME,
        C_SCORE_DATE};

    public FiveBaseRecord() {
    }
